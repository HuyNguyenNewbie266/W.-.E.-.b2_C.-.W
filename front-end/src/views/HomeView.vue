<template>
  ...
  <div class="flex h-full w-full items-center justify-center rounded-[1.9rem] bg-primary">
    <span class="text-[14rem] font-black leading-none text-white select-none">
      ?
    </span>
  </div>
          </div>
    ...
    <section class="mx-auto max-w-7xl px-6 py-16 lg:px-10">
      ...
      <div class="grid gap-6 sm:grid-cols-3">
        ...
        <router-link to="/submit" class="glass flex flex-col items-center justify-center gap-4 rounded-2xl p-10 text-center transition-all hover:scale-[1.02] hover:bg-white dark:bg-slate-800/40 text-slate-900">
          ...
          <h3 class="text-xl font-bold">Submit Ticket</h3>
